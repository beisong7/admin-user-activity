                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row card-title">
                            <div class="col">
                                <h5 class="">Activities for {{ $user->names }} </h5>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary openPopup"
                                            data-href="{{ route('activity.edit', [$activity->uid, 'type'=>'private', 'user_id'=>$user->id]) }}"
                                        ...
                                        onclick="event.preventDefault(); deleteItem('{{ route('activity.delete', [$activity->uid, 'type'=>'private', 'user_id'=>$user->id]) }}')">
